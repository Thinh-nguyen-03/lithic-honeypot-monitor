/**
 * Enhanced MCP Routes - Express routes for Model Context Protocol server integration
 * 
 * This module provides comprehensive MCP (Model Context Protocol) endpoints for conversational AI agents:
...
import { validateMCPRequest, validateIntelligenceQuery, validateAlertRequest } from '../../middleware/validation.js';
...
router.post('/subscribe',
  ...
  mcpController.subscribeToAlerts
);
...
router.delete('/unsubscribe/:sessionId',
  mcpRequestLogger,
  validateMcpSession,
  mcpController.unsubscribeFromAlerts
);
...
router.get('/subscription/status/:sessionId',
  mcpRequestLogger,
  validateMcpSession,
  mcpController.getSubscriptionStatus
);
 ...
 * @param {string} toolCallId.body.required - Unique identifier for the tool call from AI agent
...
router.get('/transaction/:transactionId',
  mcpRequestLogger,
  validateMcpSession,
  mcpController.getTransactionDetails
);
...
router.get('/transactions/recent',
  mcpRequestLogger,
  mcpController.getRecentTransactions
);
...
router.get('/transactions/merchant/:merchantName',
  mcpRequestLogger,
  mcpController.getTransactionsByMerchant
);
...
router.post('/intelligence/analyze',
  ...
  mcpController.analyzeTransactionIntelligence
);
...
router.get('/connections',
  mcpRequestLogger,
  mcpController.getMcpConnectionStats
);
